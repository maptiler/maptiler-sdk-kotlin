...
internal data class PointMultByPoint(
    val point1: MTPoint,
    val point2: MTPoint,
) : MTCommand {
    ...
    override fun toJS(): JSString =
        "(() => { " +
            "const p = new ${MTBridge.SDK_OBJECT}.Point(${point1.x}, ${point1.y})" +
            ".multByPoint(new ${MTBridge.SDK_OBJECT}.Point(${point2.x}, ${point2.y})); " +
            "return { x: p.x, y: p.y }; " +
            "})();"
}
