...
internal class WebViewExecutor(
        ...
        if (_webView == null) {
            _webView =
                WebView(context).apply {
                    ...
                    settings.userAgentString = "${settings.userAgentString} ${MTConfig.customUserAgent}"
    ...
    internal fun setWebView(webView: WebView) {
        ...
        webView.settings.userAgentString = "${webView.settings.userAgentString} ${MTConfig.customUserAgent}"
