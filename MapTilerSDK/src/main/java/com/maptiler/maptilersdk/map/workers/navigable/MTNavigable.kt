...
interface MTNavigable {
     ...
     */
    fun resetNorth(options: MTAnimationOptions? = null)
     ...
     * @param options Animation options.
     */
    fun resetNorthPitch(options: MTAnimationOptions? = null)
     ...
     * @param options Animation options.
     */
    fun snapToNorth(options: MTAnimationOptions? = null)
     ...
     *
     * @param point The screen-space point in pixels.
     * @return Geographical coordinate.
     */
    suspend fun unproject(point: MTPoint): LngLat
     ...
     */
    suspend fun getPadding(): MTPaddingOptions
